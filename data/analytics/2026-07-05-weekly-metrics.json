{
  ...
  "generated_at": "2026-07-07T23:07:33.452469+00:00",
  ...
  "projects": [
    {
      ...
      "recent_commit_subjects": [
        "fix: table header alignment and nav/menu bar rendering",
        "fix: keep qm web alive, auto-bind 0.0.0.0 on WSL2",
        "feat: redesign web UI with glassmorphism + GSAP animations",
        "feat: ship-ready prep -- README rewrite, install.sh, .env.example, LICENSE",
        "feat: complete Quartermaster phases 11-17 (eval, pipelines, guidance, query/MCP, safety, surfaces, NFR)",
        "Complete loadout activation phase",
        "Complete optional composition phase",
        "Complete trust and provenance phase",
        "Complete self-authored and status phases",
        "Complete deployment preview and rollback phase",
        "Complete source sync profiles and audit phases",
        "Phase 2 (FR-012/013 core): real upstream currency + git recursion fix"
      ],
      "done": [],
      "wip": [],
      "planned": []
    },
    {
      ...
      "evidence": "git",
      "recent_commit_subjects": [
        "Refine new-aaa-memory rebuild plan: platform re-center + adversarial pass",
        "revised prd"
      ],
      "done": [],
      "wip": [],
    ...
    },
    {
      ...
      "evidence": "git",
      "recent_commit_subjects": [
        "deploy: add link-remote-obs.sh for cross-machine (WSL2) observability",
        "deploy: add durable user systemd unit for the observability server"
      ],
      "done": [],
      "wip": [],
      "planned": []
    ...
    },
    {
      ...
      "evidence": "git",
      "recent_commit_subjects": [
        "chore: update deliberative-refinement submodule"
      ],
      "done": [],
      "wip": [],
      "planned": []
  ...
  "done": [
    ...
    "weekly-report 2026-07-07: expose Prometheus metrics [done]",
    "weekly-report 2026-07-05: render dashboard [done]",
    "weekly-report 2026-07-07: render dashboard [done]",
    "weekly-report 2026-07-07: collect evidence [done]",
    "weekly-report 2026-07-05: collect evidence [done]"
  ],
  "wip": [],
  "planned": [],
  "daily_activity": [
