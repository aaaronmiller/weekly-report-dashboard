{
  ...
  "generated_at": "2026-08-30T02:01:52.741764+00:00",
  ...
  "projects": [
    {
      ...
      "recent_commit_subjects": [
        "analytics: honest 4-week caption (last4_slope), degenerate all-zero token slope suppressed, WoW delta kept",
        "template: tasks.md refined via fleet loop 7 re-run (393-line transcript, validator GENUINE)",
        "template: revert tasks.md loop-7 change (validator HALLUCINATED verdict \u2014 transcript thin, no council evidence)",
        "template: fleet refinement batch loops 5-8 (start-here, what-to-do, tasks, index)",
        "docs: ux audit verification pass 2",
        "renderer: analytics view focuses the analytics section (state-based)",
        "ux: hide zero nav badges; analytics tab deployed",
        "analytics: per-project obsidian table, ld:project frontmatter tag support, content-match curator",
        "analytics: weekly generator (sessions/git/chrome/obsidian), atomic+flock+incremental, per-project + global",
        "template: analytics.md + approval-queue.md refined via fleet loops 3-4 (10/3/1 ISO, validated)",
        "template: prompt-corpus refined via fleet loop 2 (10/3/1 ISO, gemini exec + opus validation)",
        "analytics: add view, type, renderer, template page; schema view+type"
      ],
      "done": [],
      "wip": [],
      "planned": []
    },
    {
      ...
      "evidence": "git",
      "recent_commit_subjects": [
        "guidance: audit against current provider system-prompt guidance (Anthropic Fable 5, OpenAI GPT-5.6, Gemini \u2014 Aug 2026)",
        "changelog: record S1+S2 catalog repair (strict conventions, guidance type, loaded/disabled state)",
        "guidance artifact type + loaded/disabled state in qm status (S2)",
        "scanner: detect only the 8 artifact conventions; never catalogue content files",
        "guidance: replace ASD-STE100 mandate with context-aware OUTPUT POLICY (user-approved 2026-08-27); add prior-art rules audit",
        "deploy status: classify managed links as drift, residue as stale (QM-010, QM-011)"
      ],
      "done": [],
      "wip": [],
      "planned": []
    },
    {
      ...
      "evidence": "git",
      "recent_commit_subjects": [
        "Re-acknowledge the ARDF ledger pin (5148 -> 5180) after the 2026-08-25 AA refresh",
        "model-scan: revised output format + CASS repair (archive rebuilt, DB repaired, health guard added, root-cause doc)"
      ],
      "done": [],
      "wip": [],
      "planned": []
    },
    {
      ...
      "evidence": "git",
      "recent_commit_subjects": [
        "chore: archive prompt-named scratch dir per folder-organization directive",
        "T03-T05: grading fixes and measured gate; snapshotter NOT retired"
      ],
      "done": [],
      "wip": [],
      "planned": []
    },
    {
      ...
      "evidence": "git",
      "recent_commit_subjects": [
        "mem_store: recall injection cap 16K chars (defense in depth)",
        "mem_store: cap stored entries at 4K chars (oversized conv dumps polluted every recall)"
      ],
      "done": [],
      "wip": [],
      "planned": []
    },
    {
      ...
      "evidence": "git",
      "recent_commit_subjects": [
        "Re-pin x-row-count 5148 -> 5180 after the 2026-08-25 AA refresh (+32 rows)"
      ],
      "done": [],
      "wip": [],
      "planned": []
  ...
  "done": [
    "weekly-report 2026-08-29: automate regeneration [done]",
    "weekly-report 2026-08-29: provision Grafana dashboard [done]",
    "weekly-report 2026-08-29: expose Prometheus metrics [done]",
    "weekly-report 2026-08-29: render dashboard [done]",
    "weekly-report 2026-08-29: collect evidence [done]",
