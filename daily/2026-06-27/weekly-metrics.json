{
  ...
  "generated_at": "2026-06-28T03:16:49.346994+00:00",
  ...
  "metrics": {
    ...
    "work_planned": 0,
    "momentum_score": 40,
    "kanban_tasks_total": 30
  },
  "projects": [],
  "done": [
    "weekly-report 2026-06-27: automate regeneration [done]",
    "weekly-report 2026-06-27: provision Grafana dashboard [done]",
    "weekly-report 2026-06-27: expose Prometheus metrics [done]",
    "weekly-report 2026-06-27: render dashboard [done]",
    "weekly-report 2026-06-27: collect evidence [done]",
  ...
  "evidence": {
    "cass_health": {
      ...
      "recommended_commands": [
        {
          "id": "search-now",
          "command": "cass search '<query>' --robot --limit 10 --fields summary --robot-meta --data-dir /home/cheta/.local/share/coding-agent-search",
        ...
        },
        {
          ...
          "command": "cass pack '<query>' --robot --fields summary,health,freshness,privacy,warnings --max-tokens 4000 --data-dir /home/cheta/.local/share/coding-agent-search",
      ...
      "doctor_summary": {
        ...
        "coverage_source": {
          ...
          "generated_at": "2026-06-28T03:16:43+00:00",
      ...
      "state": {
        "index": {
          ...
          "reason": null,
          "fresh": true,
          "last_indexed_at": "2026-06-28T03:16:38.144+00:00",
          "age_seconds": 5,
          "stale": false,
          ...
          "fingerprint": {
            ...
            "checkpoint_fingerprint": "content-v1:1192:1192:105530",
        ...
        "_meta": {
          "timestamp": "2026-06-28T03:16:43+00:00",
          "data_dir": "/home/cheta/.local/share/coding-agent-search",
